...
class BlockItem {
  ...
  BlockItem({required this.type, required this.account, required this.previous, required this.representative,
            required this.balance, required this.link, required this.linkAsAccount, required this.work,
            required this.signature, required this.destination, required this.source});  
