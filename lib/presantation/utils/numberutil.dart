...
class NumberUtil {
  ...
  static Decimal getRawAsUsableDecimal(String raw) {
    ...
    Decimal result = (amount / Decimal.parse(rawPerNano.toString())) as Decimal;
    return result;
  }
  ...
  static String getRawAsUsableString(String raw) {
    NumberFormat nf = NumberFormat.currency(locale:'en_US', decimalDigits: maxDecimalDigits, symbol:'');
