// ignore_for_file: constant_identifier_names, library_private_types_in_public_api, unnecessary_null_comparison
...
import 'package:near_pay_app/presantation/ui/avatar/nonce_response.dart';
...
class AvatarChangePage extends StatefulWidget {
  ...
  const AvatarChangePage({super.key, required this.curAddress});
  @override
...
class _AvatarChangePageState extends State<AvatarChangePage> {
  ...
  void initState() {
    super.initState();
    loading = true;
    // change this url to near protocol
    String url =
  ...
  void showSendConfirmSheet() {
    ...
    Sheets.showAppHeightNineSheet(
        ...
        widget: SendConfirmSheet(
            ...
            natriconNonce: nonce, contactName: '', localCurrency: '', near: null,));
  }
