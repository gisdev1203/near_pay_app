...
import 'package:near_pay_app/presantation/ui/util/exceptions.dart';
...
class UIUtil {
  ...
  static Future<void> cancelLockEvent() async {
    ...
    Future<dynamic> delayed = Future.delayed(const Duration(seconds: 10));
    delayed.then((_) {
      return true;
    });
