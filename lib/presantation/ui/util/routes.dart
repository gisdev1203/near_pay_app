...
class NoTransitionRoute<T> extends MaterialPageRoute<T> {
  NoTransitionRoute({ required super.builder, required RouteSettings super.settings });
...
class NoPushTransitionRoute<T> extends MaterialPageRoute<T> {
  NoPushTransitionRoute({ required super.builder, required RouteSettings super.settings });
...
class NoPopTransitionRoute<T> extends MaterialPageRoute<T> {
  NoPopTransitionRoute({ required super.builder, required RouteSettings super.settings });
