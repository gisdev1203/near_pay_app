...
import 'package:near_pay_app/presantation/ui/widgets/app_simpledialog.dart';
...
class AppDialogs {
  static void showConfirmDialog(
      ...
      {required String cancelText, required Function cancelAction}) {
    showAppDialog(
      context: context,
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AppAlertDialog(
          ...
          ], key: null, semanticLabel: '', titlePadding: null, shape: null,
        );
      },
    );
  }
...
class AnimationLoadingOverlay extends ModalRoute<void> {
  ...
  AnimationLoadingOverlay(this.type, this.barrier, this.barrierStronger,
      {required this.onPoppedCallback});
