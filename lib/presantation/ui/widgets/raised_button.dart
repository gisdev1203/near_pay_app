...
class RaisedButton extends MaterialButton {
  ...
  const RaisedButton({
    ...
    required VoidCallback super.onLongPress,
    required ValueChanged<bool> super.onHighlightChanged,
    required ButtonTextTheme super.textTheme,
    required Color super.textColor,
    required Color super.disabledTextColor,
    required Color super.color,
    required Color super.disabledColor,
    required Color super.focusColor,
    required Color super.hoverColor,
    required Color super.highlightColor,
    required Color super.splashColor,
    required Brightness super.colorBrightness,
    required double super.elevation,
    required double super.focusElevation,
    required double super.hoverElevation,
    required double super.highlightElevation,
    required double super.disabledElevation,
    required EdgeInsetsGeometry super.padding,
    required VisualDensity super.visualDensity,
    required ShapeBorder super.shape,
    super.clipBehavior,
    required FocusNode super.focusNode,
    super.autofocus,
    required MaterialTapTargetSize super.materialTapTargetSize,
    required Duration super.animationDuration,
...
class _RaisedButtonWithIcon extends RaisedButton
  ...
  _RaisedButtonWithIcon({
    ...
    required super.onHighlightChanged,
    ...
    required super.highlightElevation,
    required super.disabledElevation,
