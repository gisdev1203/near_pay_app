...
// ignore_for_file: non_nullable_equals_parameter, unnecessary_null_comparison
...
class _OutlineButtonWithIcon extends OutlineButton
  ...
  _OutlineButtonWithIcon({
    ...
    required super.highlightedBorderColor,
    required super.disabledBorderColor,
...
class _OutlineButton extends StatefulWidget {
  const _OutlineButton({
    ...
    required this.child, required this.autofocus,
  })  : assert(highlightElevation >= 0.0),
        super(key: key);
