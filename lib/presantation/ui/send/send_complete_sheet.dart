// ignore_for_file: library_private_types_in_public_api, unnecessary_null_comparison, avoid_web_libraries_in_flutter
...
class SendCompleteSheet extends StatefulWidget {
  ...
  const SendCompleteSheet({super.key, required this.amountRaw, required this.destination, required this.contactName, required this.localAmount, required this.paymentRequest, required this.natriconNonce});  
                              ...
                              children: <Widget>[
                                ...
                                UIUtil.smallScreen(context)
                                    ...
                                    : UIUtil.threeLineAddressText(
                                        context, destinationAltered, type: ThreeLineAddressTextType.SUCCESS, contactName: '')
                              ],
                            )
                          : UIUtil.threeLineAddressText(
