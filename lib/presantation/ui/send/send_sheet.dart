// ignore_for_file: library_private_types_in_public_api, use_build_context_synchronously, unnecessary_null_comparison, dead_code, constant_identifier_names
...
import 'package:near_pay_app/presantation/ui/widgets/one_or_three_address_text.dart';
...
class SendSheet extends StatefulWidget {
  ...
  const SendSheet(
      {super.key, required this.localCurrency,
      required this.contact,
      required this.address,
      required this.quickSendAmount});
...
class _SendSheetState extends State<SendSheet> {
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: OneOrThreeLineAddressText(
                  ...
                  type: AddressTextType.PRIMARY60, contactName: '',),
            ),
                      ...
                      if (_sendAddressController.text.startsWith("@") &&
                            ...
                            Sheets.showAppHeightNineSheet(
                                ...
                                widget: SendConfirmSheet(
                                    ...
                                    localCurrency: _localCurrencyMode
                                        ? _sendAmountController.text
                                        : null), color: null, onDisposed: null, barrier: null);
                          }
                        });
                        ...
                        Sheets.showAppHeightNineSheet(
                            ...
                            widget: SendConfirmSheet(
                                ...
                                localCurrency: _localCurrencyMode
                                    ? _sendAmountController.text
                                    : null, contactName: '', natriconNonce: null, near: null,), color: null, onDisposed: null, barrier: null);
                      }
                    }),
                  ],
                ),
                      ...
                      if (!hasError &&
                        ...
                        Sheets.showAppHeightNineSheet(
                            ...
                            widget: SendConfirmSheet(
                                ...
                                localCurrency: _localCurrencyMode
                                    ? _sendAmountController.text
                                    : null, natriconNonce: null, near: null,), color: null, barrier: null, onDisposed: null);
                      }
                                        }
                    })
                  ],
  ...
  String _convertLocalCurrencyToCrypto() {
    ...
    return NumberUtil.truncateDecimal((valueLocal / conversion) as Decimal).toString();
  }
  ...
  getEnterAmountContainer() {
    return AppTextField(
      ...
      }, fadePrefixOnCondition: null, prefixShowFirstCondition: null, overrideTextFieldWidget: null, leftMargin: null, rightMargin: null,
    );
    ...
    return AppTextField(
        ...
        suffixButton: TextFieldButton(
          ...
          onPressed: () {
            ...
            } as FutureOr Function(ClipboardData? value));
          },
        ),
        fadeSuffixOnCondition: true,
        ...
        overrideTextFieldWidget: _addressValidAndUnfocused
            ? GestureDetector(
                ...
                child: UIUtil.threeLineAddressText(
                    context, _sendAddressController.text, contactName: ''))
            : null, keyboardType: null, onSubmitted: null, leftMargin: null, rightMargin: null,);
  } //************ Enter Address Container Method End ************//
  //*************************************************************//
}
